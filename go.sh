...
for f in go.sh stop.sh diag.sh maps.sh phone.sh pull.sh scripts/run-ultimate.sh scripts/run-ultimate.py scripts/rts_catcher_min.py scripts/wazemap.py scripts/map_auto.py scripts/waze-diag.sh scripts/waze-maps-dir.sh scripts/waze-patch.sh; do
